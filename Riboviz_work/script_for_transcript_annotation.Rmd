...
```{r}
# Download annotations and genome seq from here - S. pombe GFF, from https://www.pombase.org/data/genome_sequence_and_features/gff3/Schizosaccharomyces_pombe_all_chromosomes.gff3.gz
...
# read gff as GRanges object, fasta as datastring 
yeast_annot <- readGFFAsGRanges("s_pombe.gff.gz")
yeast_genome <- readDNAStringSet("S_pombe.fa.gz")
```
head(yeast_genome) shows the following object:
[1]   20000 CAATTGTAAACCATATTGGTA...TAAGGGTTCAGAGCGAGGAA chr_II_telomeric_...
[2] 5579133 GATCACGTACATCACCTTGTA...AGAAGCAAACCGCATCGATC I Schizosaccharom...
[3] 4539804 GATCTCGCAACTCTTAATAAA...TCGGGGAGGATGGGAAATTT II Schizosaccharo...
[4] 2452883 GATCAGCCAAAATGGCTGATC...ATCAAGAACGAAAGTTAGGG III Schizosacchar...
[5]   20128 AAAATTCGGGTAAAATAATTT...TTTCTTTTTTAAATTATTTT mating_type_regio...
[6]   19431 AATGTGTAATTTGAATCAATT...ATAAATATTTTTATATATGT mitochondrial Sch...

head(yeast_annot shows the following GRanges object:
...
# This changes the names of the chromosomes, was hard coded for another dataset so changed to names(yeast_genome) <- paste(c("chr_II_telomeric_gap", "I", "II","III", "mating_type_region", "mitochondrial")), to match gff file for S.pombe                                             
names(yeast_genome) <- paste("chr",c(as.character(as.roman(1:16)),"mt"),sep="")

# Adjust the annotations for 250nt shift, needed so sequneces align correctly 
yeast_annot <- shift(yeast_annot,250)
# Get the annotations for all CDS of uncharacterized and verified genes. Unfortunately, orf_classification is not an option in the S. pombe
